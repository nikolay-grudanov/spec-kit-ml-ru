...
When creating ML task breakdown:

1. **Load appropriate ML example** (BEFORE creating tasks):
   ...
   - Load the selected example's tasks.md to understand task breakdown and structure
   - Use the example as a reference for task organization, dependencies, and priorities
   - Adapt the example's task structure to your specific ML plan requirements

2. **Align with plan**: Ensure tasks cover all phases outlined in the ML implementation plan

3. **Granularity**: Break down tasks at similar level to examples (not too detailed, not too vague)
