...
When creating this ML technical plan:

1. **Load appropriate ML example** (BEFORE creating plan):
   ...
   - Load the selected example's plan.md to understand technical approach and structure
   - Use the example as a reference for architecture patterns, training strategies, and MLOps setup
   - Adapt the example's approach to your specific task requirements

2. **Align with spec**: Ensure plan references the same ML task type and requirements from the spec

3. **MLOps integration**: Incorporate MLOps practices from examples (experiment tracking, versioning, monitoring)
