...
1. Настройка окружения:
    ```bash
    cd /home/gna/workspase/projects/spec-kit-ml-ru/.specify && make setup
    # Или:
...
2. Установка зависимостей:
    ```bash
    cd /home/gna/workspase/projects/spec-kit-ml-ru/.specify && pip install -r .ml-spec/config/requirements-pip.txt
    # Или с Makefile:
    make setup
    ```
...
3. Запуск экспериментов:
    ```bash
    cd test-new && jupyter notebook notebooks/01_eda.ipynb
    ```
