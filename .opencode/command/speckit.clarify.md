...
## ML-Specific Categories for Clarification

When scanning for ambiguities in ML specifications, include these ML-specific categories in the taxonomy:

### ML Model Scope & Behavior:
- Model type and architecture (CNN, LSTM, tree-based, transformers)
...
Include these ML-specific categories in the ambiguity scan and prioritize clarifications from these areas when relevant to the feature being clarified.